...
describe('isRetryableError', () => {
  describe('413 Payload Too Large', () => {
    it('treats explicit "413" in the error message as retryable', async () => {
    ...
    it('treats common 413 phrasings (no status code) as retryable', async () => {
  ...
  describe('404 model removed / not found (the bug #66 fixes)', () => {
    it('treats explicit "404" in the error message as retryable', async () => {
    ...
    it('catches OpenRouter\'s "No endpoints found" phrasing for deprecated models', async () => {
  ...
  describe('existing categories still classify correctly', () => {
    ...
    it('4xx auth/validation errors are NOT retryable', async () => {
